...
const suggestionGroups: SuggestionGroup[] = [
  {
    title: 'Quy trình phân tách',
    content: [
      { icon: 'tabler-chart-bar', title: 'Danh sách', url: { name: 'manage-sample-separation-list' } },
    ],
  },
];
...
const noDataSuggestions: Suggestion[] = [
  { icon: 'tabler-chart-bar', title: 'Danh sách phân tách', url: { name: 'manage-sample-separation-list' } },
];
